    ...
    <>
      <div className={cn('flex flex-col items-start gap-3 sm:flex-row sm:items-center', className)}>
        <div className="relative">
          <div className="relative h-20 w-20 overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-primary to-[#10B981] shadow-[0_1px_2px_rgba(10,102,64,0.04)]">
            {displayUrl ? (
        ...
        <div className="min-w-0 space-y-2">
          <div>
            <p className="text-sm font-semibold text-forest">Profile photo</p>
