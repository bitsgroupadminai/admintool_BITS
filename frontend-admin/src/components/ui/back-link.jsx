...
export const softHeroClassName =
  'overflow-hidden rounded-2xl border border-[#E2EEE8] bg-gradient-to-br from-[#F6FAF5] via-surface to-[#FAFBFA] shadow-[0_1px_2px_rgba(10,102,64,0.04)]';

export const softFooterClassName =
  'rounded-2xl border border-[#E2EEE8] bg-surface shadow-[0_1px_2px_rgba(10,102,64,0.04)]';
